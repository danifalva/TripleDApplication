...
class DinerTableViewController: UITableViewController,XMLParserDelegate {
    ...
    func displayOnUI(){
        for a in myRestaurant {
            ...
            //getAddressFromLatLon(lat: a.latitude, long: a.longitude)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "DinerTableViewCellReuseIdentifier", for: indexPath)

        // Configure the cell...
        if let dinerCell = cell as? DinerTableViewCell {
            
            dinerCell.dinerNameLabel?.text = myRestaurant[indexPath.row].name
            dinerCell.dinerDescripLabel?.text = myRestaurant[indexPath.row].descrip
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let actualDestVC = segue.destination as? DinerDetailViewController {
