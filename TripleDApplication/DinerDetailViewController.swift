//
//  DinerDetailViewController.swift
//  TripleDApplication
//
//  Created by Daniela Alvarez  on 4/26/18.
...
class DinerDetailViewController: UIViewController, XMLParserDelegate, MKMapViewDelegate {

    //MARK: - outlets
    @IBOutlet weak var dinerNameLabel: UILabel!
    @IBOutlet weak var dinerDescripLabel: UILabel!
    @IBOutlet weak var dinerLocationLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        if let actualRow = rowNum,
            ...
            dinerNameLabel.text = actualModel[actualRow].name
            dinerDescripLabel.text = actualModel[actualRow].descrip
            dinerLocationLabel.text = actualModel[actualRow].coordinates
            
            let addressSTring = getAddressFromLatLon(lat: actualModel[actualRow].longitude, long: actualModel[actualRow].latitude) {
                (addressString) in
                self.dinerLocationLabel.text = addressString
